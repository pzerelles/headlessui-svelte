...
export function assertLinkedWithLabel(element: HTMLElement | null, label: HTMLElement | HTMLElement[]) {
  try {
...
export function assertNotLinkedWithLabel(element: HTMLElement | null, label: HTMLElement | HTMLElement[]) {
  try {
    if (element === null) return expect(element).not.toBe(null)
...
export function assertLinkedWithDescription(element: HTMLElement | null, description: HTMLElement | HTMLElement[]) {
  try {
    if (element === null) return expect(element).not.toBe(null)
...
export function assertComboboxButtonLinkedWithComboboxLabel(button = getComboboxButton(), label = getComboboxLabel()) {
  try {
    ...
    if (err instanceof Error) Error.captureStackTrace(err, assertComboboxButtonLinkedWithComboboxLabel)
    throw err
  }
}

export function assertActiveComboboxOption(item: HTMLElement | null, combobox = getComboboxInput()) {
  try {
    if (combobox === null) return expect(combobox).not.toBe(null)
    if (item === null) return expect(item).not.toBe(null)
...
export function assertNotActiveComboboxOption(item: HTMLElement | null, combobox = getComboboxInput()) {
  try {
    if (combobox === null) return expect(combobox).not.toBe(null)
    if (item === null) return expect(item).not.toBe(null)
...
export function assertListboxButtonLinkedWithListboxLabel(button = getListboxButton(), label = getListboxLabel()) {
  try {
    ...
    if (err instanceof Error) Error.captureStackTrace(err, assertListboxButtonLinkedWithListboxLabel)
    throw err
  }
}
